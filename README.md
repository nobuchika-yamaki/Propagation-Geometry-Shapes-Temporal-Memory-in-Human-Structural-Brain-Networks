...
primary equal-weight analysis;

descriptive analyses and IID temporal-dependence falsification;

extended memory spectrum through lag 1024;

empirical structural-connectivity weighting robustness;

conduction-compensation sensitivity analysis.
